...
import {
  ...
  CONFIRM_DAPPLET_PATH,
  SIGNATURE_REQUEST_PATH,
} from '../../../routes'
import { isConfirmDeployContract, isDappletTransaction } from '../../../helpers/transactions.util'
import {
...
export default class ConfirmTransactionSwitch extends Component {
  ...
  redirectToTransaction () {
    ...
    if (isDappletTransaction(txData)) {
      const pathname = `${CONFIRM_TRANSACTION_ROUTE}/${id}${CONFIRM_DAPPLET_PATH}`
